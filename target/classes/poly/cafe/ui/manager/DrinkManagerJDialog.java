...
public class DrinkManagerJDialog extends javax.swing.JDialog implements DrinkController {
    ...
    @Override
    public void edit() {
        Drink entity = drinks.get(tblDrinks.getSelectedRow());
        this.setForm(entity);
    ...
    private void btnImportActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            List<Drink> importedDrinks = XExcel.importDrinks();
            if (importedDrinks != null && !importedDrinks.isEmpty()) {
                for (Drink drink : importedDrinks) {
                    dao.create(drink);
                }
                XDialog.alert("Nhập dữ liệu thành công!");
                fillToTable();
            }
        } catch (IOException ex) {
