...
import poly.cafe.ui.component.RadioJPanel;
import poly.cafe.ui.component.TimeFilterJPanel;
...
//    TimeFilterJPanel t = new TimeFilterJPanel();
    ...
    public void fillToTable() {
        ...
        for (Bill bill : bills) {
            model.addRow(new Object[]{
                ...
                bill.getUsername(),
                bill.getCardId(),
                XDate.format(bill.getCheckin(), Bill.DATE_PATTERN),
                bill.getCheckout() != null ? XDate.format(bill.getCheckout(), Bill.DATE_PATTERN) : "",
    ...
    @Override
    public void edit() {
        Bill entity = bills.get(tblBills.getSelectedRow());
        this.setForm(entity);
        ...
        if (XDialog.confirm("Bạn thực sự muốn xóa các mục chọn?")) {
            for (int i = 0; i < tblBills.getRowCount(); i++) {
                if ((Boolean) tblBills.getValueAt(i, 6)) {
                    dao.deleteById(bills.get(i).getId());
                }
            }
            this.fillToTable();
        }
