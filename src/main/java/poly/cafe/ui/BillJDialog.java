...
public class BillJDialog extends javax.swing.JDialog implements BillController {
    ...
    private void setupUI() {
        ...
        XUI.setPanelPadding(jPanel4, 10, 10, 10, 10);
        
        // Customize labels
        XUI.customizeLabel(jLabel1);
        XUI.customizeLabel(jLabel2);
        XUI.customizeLabel(jLabel3);
        XUI.customizeLabel(jLabel4);
        XUI.customizeLabel(jLabel5);
        XUI.customizeLabel(jLabel6);
        
        // Customize text fields
        XUI.customizeTextField(txtId);
        XUI.customizeTextField(txtCardId);
        XUI.customizeTextField(txtCheckin);
        XUI.customizeTextField(txtUsername);
        XUI.customizeTextField(txtStatus);
        XUI.customizeTextField(txtCheckout);
        
        // Customize buttons
        XUI.customizeButton(btnAdd, new Color(0, 120, 212));
        XUI.customizeButton(btnRemove, new Color(220, 53, 69));
        XUI.customizeButton(btnCheckout, new Color(40, 167, 69));
        XUI.customizeButton(btnCancel, new Color(108, 117, 125));
        
        // Customize table
        XUI.customizeTable(tblBillDetails);
    }
