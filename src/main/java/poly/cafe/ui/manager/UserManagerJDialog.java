...
public class UserManagerJDialog extends javax.swing.JDialog implements UserController {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtFullname1, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel6Layout.createSequentialGroup()
                            ...
                            .addGap(5, 5, 5)
                            .addComponent(txtFullname1, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(5, 5, 5)
    ...
    public void setForm(User entity) {
        ...
        txtEmail.setText(entity.getFullname());
    ...
    public void create() {
        try {
            ...
            user.setFullname(txtFullname1.getText());
            ...
            XDialog.alert("Lỗi thêm tài khoản: " + ex.getMessage());
        }
    }
    ...
    public void update() {
        try {
            ...
            if (user == null) {
                XDialog.alert("Vui lòng chọn tài khoản cần cập nhật!");
                return;
            }
            user.setEmail(txtEmail.getText());
            user.setFullname(txtFullname1.getText());
            ...
            XDialog.alert("Lỗi cập nhật tài khoản: " + ex.getMessage());
        }
    }
    ...
    private void loadTable() {
        ...
        try {
            ...
            XDialog.alert("Lỗi tải dữ liệu: " + ex.getMessage());
        }
    }
}